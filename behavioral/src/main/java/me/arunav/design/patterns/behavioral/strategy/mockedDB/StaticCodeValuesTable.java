...
public class StaticCodeValuesTable {
    ...
    public static void loadData() {
        ...
        staticCodeValues.put("key1", new StaticCodeValues("key1_attr1", Arrays.asList("key1_attr2a", "key1_attr2b"), true, 1));
        staticCodeValues.put("key2", new StaticCodeValues("key2_attr1", Arrays.asList("key2_attr2a", "key2_attr2b"), false, 2));
        staticCodeValues.put("key3", new StaticCodeValues("key3_attr1", Arrays.asList("key3_attr2a", "key3_attr2b"), false, 3));
    }
}
